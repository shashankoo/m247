...
return lineItems;},replaceUnsupportedCharacters:function(str){str.replace('/[^a-zA-Z0-9\s\-.\']/','');return str.substr(0,127);},canSendLineItems:function(){return window.checkoutConfig.payment[this.getCode()].canSendLineItems;}});});